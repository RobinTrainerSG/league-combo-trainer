...
function startTraining() {
    ...
    document.getElementById("comboDisplay").innerHTML = customCombo.map(k => {
        if (k === "FLASH") {
          return `<img src="images/flash.png" alt="Flash" class="spell-icon">`;
        } else if (k === "IGNITE") {
          return `<img src="images/ignite.png" alt="Ignite" class="spell-icon">`;
        } else if (k === "AA") {
          return `<img src="images/sword.png" alt="Auto Attack" class="spell-icon">`;
        } else {
